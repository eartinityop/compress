...
# Public URL of this Render service (provided automatically)
SERVICE_URL = os.environ.get("RENDER_EXTERNAL_URL", "http://localhost:8000")
BASE_URL = f"{SERVICE_URL}/bot"

# Internal address of the local Bot API server
    ...
    if data.startswith("quality_"):
        ...
        payload = {
            ...
            "inputs": {
                ...
                "api_base_url": BASE_URL   # workflow will use the local API via the proxy
            }
        }
